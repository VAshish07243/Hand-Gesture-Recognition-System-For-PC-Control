...
# Initial brightness value and bar position
brightness = 1.0
brightnessBar = 400
...
while True:
    ...
    if len(lm_list) != 0:
        ...
        # Interpolate brightness based on hand distance
        brightness = np.interp(length, [50, 300], [0.5, 1.5])
    ...
    # Draw brightness bar and level
    cv2.rectangle(img, (50, 150), (85, 400), (255, 0, 0), 3)
    cv2.rectangle(img, (50, int(brightnessBar)), (85, 400), (255, 0, 0), cv2.FILLED)
    cv2.putText(img, f'Brightness: {brightness:.2f}', (40, 450), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 0, 0), 3)
